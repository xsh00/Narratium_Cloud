  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#171717] via-[#1a1816] to-[#171717] p-4">
      <div className="max-w-4xl mx-auto">
        {/* 页面标题 */}
        <div className="mb-8">
          <h1 className={`text-3xl font-bold text-[#eae6db] ${serifFontClass} bg-gradient-to-r from-amber-300 via-amber-200 to-amber-300 bg-clip-text text-transparent mb-2`}>
            预设管理系统
          </h1>
          <p className="text-[#a18d6f] text-lg">
            管理角色对话的预设JSON文件
          </p>
        </div>
        ...
        <div className="bg-gradient-to-br from-[#1a1816]/95 via-[#252220]/95 to-[#1a1816]/95 backdrop-blur-xl border border-[#534741]/60 rounded-xl p-6 mb-6">
          <h2 className={`text-xl font-semibold text-[#eae6db] ${serifFontClass} mb-4`}>
            预设初始化状态
          </h2>
          
          <div className="space-y-4">
            <div className="flex items-center space-x-3">
              <div className={`w-3 h-3 rounded-full ${initializationStatus?.initialized ? 'bg-green-500' : 'bg-red-500'}`}></div>
              <span className="text-[#eae6db]">
                初始化状态: {initializationStatus?.initialized ? '已完成' : '未完成'}
              </span>
            </div>
              ...
              >
                <div className="flex items-start justify-between">
                  <div className="flex-1">
                    <h3 className={`text-lg font-semibold text-[#eae6db] ${fontClass} mb-2`}>
        ...
        <div className="bg-gradient-to-br from-[#1a1816]/95 via-[#252220]/95 to-[#1a1816]/95 backdrop-blur-xl border border-[#534741]/60 rounded-xl p-6 mt-6">
          ...
          <div className="space-y-4 text-[#a18d6f]">
            <div>
              <h3 className="text-[#eae6db] font-semibold mb-2">1. 预设文件位置</h3>
              <p className="text-sm">
                预设JSON文件应放置在 <code className="bg-[#333]/50 px-2 py-1 rounded">public/presets/</code> 目录下
              </p>
            </div>
            ...
            <div>
              ...
              <p className="text-sm">
                用户首次访问应用时，系统会自动导入配置为 <code className="bg-[#333]/50 px-2 py-1 rounded">autoImport: true</code> 的预设文件
              </p>
            </div>
            
            <div>
              <h3 className="text-[#eae6db] font-semibold mb-2">3. 手动初始化</h3>
              <p className="text-sm">
