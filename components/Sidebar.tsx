        ...
        <ul className="space-y-1">
          ...
          <li className="min-h-[15px]">
            <div className="mb-4">
              ...
              >
                <span>{t("sidebar.socialFeed")}</span>
                {isOpen && (
                  <button
                    onClick={() => setIsGameOpen(!isGameOpen)}
                    className="w-5 h-5 flex items-center justify-center text-[#8a8a8a] hover:text-amber-400 transition-colors duration-300 login-fantasy-bg rounded-sm"
          ...
          <li className="min-h-[15px]">
            <div className="mb-4">
              ...
              <div
                className={`overflow-hidden transition-all duration-300 ${isOpen ? (isCreatorOpen ? "max-h-40 opacity-100 mt-1" : "max-h-0 opacity-0 mt-0") : "max-h-40 opacity-100 mt-1"} mx-1`}
              >
