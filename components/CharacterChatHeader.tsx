    ...
    <div className="bg-[#1a1816] border-b border-[#534741] p-4 flex items-center">
      ...
      <div className="flex flex-col md:flex-row md:items-center space-y-2 md:space-y-0 md:space-x-4 flex-1">
        <div className="flex items-center space-x-4">
          ...
          <h2 className={`text-base md:text-lg text-[#eae6db] magical-text ${serifFontClass} truncate max-w-[120px] md:max-w-[200px]`}>
            {character.name}
          </h2>
        </div>
        ...
        <div className="flex flex-wrap gap-2 md:gap-0">
          ...
          >
            <div className={`relative w-6 h-6 md:mr-2 flex items-center justify-center transition-colors ${
              activeView === "worldbook" 
                ? "text-[#aef6da]" 
            ...
            <span className={`font-medium text-sm transition-all duration-300 ${serifFontClass} hidden md:block ${
              activeView === "worldbook" 
                ? "text-[#aef6da]" 
