    ...
    <div className="mb-3">
      ...
      >
        <div className="bg-[#1f1d1a]/80 border border-[#534741]/40 rounded-lg p-4 backdrop-blur-sm">
          <div
            className={`text-sm text-[#c0a480] leading-relaxed whitespace-pre-wrap ${serifFontClass}`}
          >
            {thinkingContent}
          </div>
        </div>
